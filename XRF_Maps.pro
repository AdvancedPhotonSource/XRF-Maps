...
QMAKE_CXXFLAGS += -DQT_CORE_LIB -DQT_GUI_LIB -DQT_WIDGETS_LIB
#end VTK
...
QMAKE_CXXFLAGS += -DQT_CORE_LIB -DQT_GUI_LIB -DQT_WIDGETS_LIB -D_BUILD_WITH_QT
#end VTK

QMAKE_CXXFLAGS += -Waddress
QMAKE_CXXFLAGS += -Warray-bounds=1
QMAKE_CXXFLAGS += -Wbool-compare
QMAKE_CXXFLAGS += -Wbool-operation
QMAKE_CXXFLAGS += -Wc++11-compat  -Wc++14-compat
QMAKE_CXXFLAGS += -Wcatch-value
QMAKE_CXXFLAGS += -Wchar-subscripts
QMAKE_CXXFLAGS += -Wcomment
QMAKE_CXXFLAGS += -Wduplicate-decl-specifier
QMAKE_CXXFLAGS += -Wenum-compare
QMAKE_CXXFLAGS += -Wformat
#QMAKE_CXXFLAGS += -Wint-in-bool-context
QMAKE_CXXFLAGS += -Wimplicit
QMAKE_CXXFLAGS += -Wimplicit-int
QMAKE_CXXFLAGS += -Wimplicit-function-declaration
QMAKE_CXXFLAGS += -Winit-self
QMAKE_CXXFLAGS += -Wlogical-not-parentheses
QMAKE_CXXFLAGS += -Wmain
QMAKE_CXXFLAGS += -Wmaybe-uninitialized
QMAKE_CXXFLAGS += -Wmemset-elt-size
QMAKE_CXXFLAGS += -Wmemset-transposed-args
QMAKE_CXXFLAGS += -Wmisleading-indentation
QMAKE_CXXFLAGS += -Wmissing-attributes
QMAKE_CXXFLAGS += -Wmissing-braces
#QMAKE_CXXFLAGS += -Wmultistatement-macros
QMAKE_CXXFLAGS += -Wnarrowing
QMAKE_CXXFLAGS += -Wnonnull
QMAKE_CXXFLAGS += -Wnonnull-compare
QMAKE_CXXFLAGS += -Wopenmp-simd
QMAKE_CXXFLAGS += -Wparentheses
QMAKE_CXXFLAGS += -Wpointer-sign
QMAKE_CXXFLAGS += -Wreorder
QMAKE_CXXFLAGS += -Wrestrict
QMAKE_CXXFLAGS += -Wreturn-type
QMAKE_CXXFLAGS += -Wsequence-point
QMAKE_CXXFLAGS += -Wsign-compare
QMAKE_CXXFLAGS += -Wsizeof-pointer-div
QMAKE_CXXFLAGS += -Wsizeof-pointer-memaccess
QMAKE_CXXFLAGS += -Wstrict-aliasing
QMAKE_CXXFLAGS += -Wstrict-overflow=1
